...
const StudentProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const responce = await fetch(`http://${serverIP}:${serverPort}/showData/viewsData`, {
                    method: 'POST',
                    mode: 'cors',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(body),
        ...
        const uploadImage = async () => {
            if (uploadedImage) {
                try {
                    ...
                    const response = await fetch(`http://${serverIP}:${serverPort}/updateData/profileImage`, {
                        method: 'POST',
                        body: formData,
                    });
                            ...
                            <Grid item xs={12}>
                                <div ref={formRef}>
                                    ...
                                    <div className='text-white mb-4 headButton'>
                                        ...
                                        {editMode && (
                                            <>
                                                <Button variant='primary' className='text-light' style={{ padding: '0 1.5rem 0 0.2rem' }} onClick={updateAddress}>
                                                    <FontAwesomeIcon
                                                        icon={faSave}
                                                        className='mx-1'
                                                    />
                                    ...
                                    <Card className='mb-lg-4'>
                                        ...
                                        <Card.Body>
                                            <div className='imageLeft mb-5'>
                                                ...
                                                <Modal show={showModal} onHide={handleCloseModal} style={{ marginTop: '70px' }}>
